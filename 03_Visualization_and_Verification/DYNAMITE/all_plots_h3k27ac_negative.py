...
# H3K27ac
l1_p6 = pd.read_table('/home/kevin/tmp/DYNAMITE/L1_vs_p6/H3K27ac/Learning_Results/Regression_Coefficients_Entire_Data_Set_Integrated_Data_For_Classification.txt').sort_values(['value'], ascending=True)
l1_p13 = pd.read_table('/home/kevin/tmp/DYNAMITE/L1_vs_p13/H3K27ac/Learning_Results/Regression_Coefficients_Entire_Data_Set_Integrated_Data_For_Classification.txt').sort_values(['value'], ascending=True)
l10_p6 = pd.read_table('/home/kevin/tmp/DYNAMITE/L10_vs_p6/H3K27ac/Learning_Results/Regression_Coefficients_Entire_Data_Set_Integrated_Data_For_Classification.txt').sort_values(['value'], ascending=True)
l10_p13 = pd.read_table('/home/kevin/tmp/DYNAMITE/L10_vs_p13/H3K27ac/Learning_Results/Regression_Coefficients_Entire_Data_Set_Integrated_Data_For_Classification.txt').sort_values(['value'], ascending=True)
lactation_pregnancy = pd.read_table('/home/kevin/tmp/DYNAMITE/Lactation_vs_Pregnancy/H3K27ac/Learning_Results/Regression_Coefficients_Entire_Data_Set_Integrated_Data_For_Classification.txt').sort_values(['value'], ascending=True)
...
time = 'L10 vs p6'
ax = sns.barplot(x= l10_p6.index, y=time, data=l10_p6, color=color)
ax.set_title(time)
ax.set_ylabel('Normalized feature value')
ax.set_xlabel('')
plt.xticks(rotation=60)
...
time = 'L10 vs p13'
ax = sns.barplot(x= l10_p13.index, y=time, data=l10_p13, color=color)
ax.set_title(time)
ax.set_ylabel('Normalized feature value')
ax.set_xlabel('')
ax.set_xticklabels(ax.get_xticklabels(), rotation=60)
