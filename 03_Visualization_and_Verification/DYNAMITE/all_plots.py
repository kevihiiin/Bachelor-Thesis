...
l1_p13 = pd.read_table('/home/kevin/tmp/DYNAMITE/L1_vs_p13/H3K4me3/Learning_Results/Regression_Coefficients_Entire_Data_Set_Integrated_Data_For_Classification.txt').sort_values(['value'], ascending=False)
lactation_pregnancy = pd.read_table('/home/kevin/tmp/DYNAMITE/Lactation_vs_Pregnancy/H3K4me3/Learning_Results/Regression_Coefficients_Entire_Data_Set_Integrated_Data_For_Classification.txt').sort_values(['value'], ascending=False)
